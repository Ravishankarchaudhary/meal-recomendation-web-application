...
const healthRecommendationsData = {
  fever: {
    ...
    recipes: [
      { title: "Vegetable Khichdi", image: "veg_khichdi.png", desc: "Soft and easily digestible comfort meal." },
  ...
  "cold-cough": {
    ...
    recipes: [
      ...
      { title: "Pepper Garlic Soup", image: "soup.png", desc: "Spicy broth that helps clear nasal congestion." }
    ]
  },
  ...
  "food-poisoning": {
    ...
    recipes: [
      ...
      { title: "Vegetable Clear Soup", image: "veg_soup.png", desc: "Keeps you hydrated and nourished." }
    ]
  }
};
...
const dietRecommendationsData = {
  ...
  "balanced": {
    ...
    recipes: [
      ...
      { title: "Grilled Chicken Salad", desc: "Perfect balanced protein meal.", image: "grilled_chicken.png" }
    ]
  },
